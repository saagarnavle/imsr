...
<div class="col-sm-12" style="font-size: 20px;">
  ...
  <li class="active">MMS</li>
            ...
            <div class="panel-group" id="accordion" role="tablist" aria-multiselectable="false" style="width: 100%;align-content: center;">
                ...
                <div class="panel panel-default" >
                    ...
                    <div id="collapsefive" class="panel-collapse collapse" role="tabpanel" aria-labelledby="headingfive" >
                        ...
                        <table border="1" style="width: 120%">
                            <tr>
                                <td>Open Category</td><td>   SC</td><td>  ST/NT/VJ</td><td>    OBC</td>
                            </tr>
